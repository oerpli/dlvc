...
It is done using the transformation in \eqref{eq:ycc} and since our implemantation was very inefficent, we used it as a preprocessing step rather than an online transformation. 
\begin{figure}
