...
It is done using the transformation in Fig. \ref{YCCformula} and since our implemantation was very inefficent, we used it as a preprocessing step rather than an online transformation. 
\begin{figure}
\includegraphics[width=0.9\textwidth]{./img/rgb-ycc.png}
\captionof{figure}{Tranfomation formula \cite{YCCWiki}}
\label{YCCformula}
\end{figure}
