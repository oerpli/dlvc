...
We used a grid search for finding good parameter for weight decay and learning rate. Using \ref{figparam-opt-hog6} HOG features instead of the raw images leads to significantly higher validation accuracy. Classifier on raw images primarily overfits (increasing training accuracy but sinking validation accuracy).
