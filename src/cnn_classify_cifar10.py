...
reshape = ToTheanoFormatImageTransformation((32,32,3))
...
model = Sequential()
model.add(Lay.Conv2D(16, 3 , 3, border_mode='same', input_shape=(3, 32, 32),activation='relu'))
model.add(Lay.MaxPooling2D((2,2)))
model.add(Lay.Conv2D(32,3,3, border_mode='same',activation = 'relu'))
model.add(Lay.MaxPooling2D((2,2)))
model.add(Lay.Conv2D(32,3,3, border_mode='same',activation = 'relu'))
model.add(Lay.MaxPooling2D((2,2)))
