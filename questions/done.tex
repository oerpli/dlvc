...
Per sample normalization makes sure, that each sample has zero main and unit variance, but espacially for color image and per channel operation, this might yield an unwanted result (eg underwater picture will have almost 0 black channel, and this IS important).
